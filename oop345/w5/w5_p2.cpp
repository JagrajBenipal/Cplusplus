...
int main(int argc, char **argv)
{
    ...
    auto updatePrice = [usdToCadRate, gbpToCadRate](Book &other)
    {
        if (other.country() == "US")
            other.price() = other.price() * usdToCadRate;
        else if (other.country() == "UK" && (other.year() > 1990 && other.year() < 1999))
            other.price() = other.price() * gbpToCadRate;
    };
    std::cout << "-----------------------------------------\n";
